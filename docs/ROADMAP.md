...
- [x] Persisted history is validated on load and before save for fingerprint/UID shape, unique technologies, unique scan IDs, and unique per-scan NDEF indexes.
