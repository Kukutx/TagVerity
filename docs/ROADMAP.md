...
- [x] Android debug plus unsigned ARM32+ARM64 release AAB/ABI verification, final merged-manifest NFC/no-INTERNET checks, iOS NFC metadata/entitlement/Xcode-wiring validation, and unsigned iOS release compile in GitHub Actions.
